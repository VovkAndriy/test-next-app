...
const Header = () => {
  ...
  return (
    <div className="fixed top-0 z-50 flex text-base sm:text-xl font-light md:text-3xl flex-row px-10 justify-between md:justify-start gap-3 bg-black/90 md:bg-black/85  md:gap-9 items-center p-2.5 md:px-6 md:pl-24 text-gray w-full h-24">
